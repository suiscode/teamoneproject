...
export const UserProfile = () => {
    ...
    return (
        <>
            <div id="profile" className="w-screen h-screen flex flex-col justify-center items-center  text-white">
                <div className="backdrop-sepia bg-black border-2 w-[450px] h-[580px] ml-10 rounded-2xl flex flex-col items-center justify-between gap-5 p-10">
                    ...
                    <Button className="bg-black w-40 text-white " variant="outline">Button</Button>
